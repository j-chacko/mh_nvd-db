...
# Provide the report start and end date
AssStart_Date = datetime(2021, 9, 26)
AssEnd_Date = datetime(2021, 10, 25)
...
def nvd_to_csv(CPE_Name, FileName):
	...
	for eachCVE in r:
		print (eachCVE.id, str(eachCVE.score[0]), eachCVE.score[1], eachCVE.publishedDate, eachCVE.url)
